	...
	public class FacebookGroupAPI : BaseFacebookAPI
	{
		...
		public ResultModel ShareLinkPost(string link, string content)
		{
			using (var rq = new Leaf.xNet.HttpRequest())
			{
				...
				RequestParams pr;
				//Lấy shareID
				HttpsHelper.AddHeaderxNet(rq, @"Cache-Control: max-age=0
                                                dpr: 1
                                                viewport-width: 2510
				...
				HttpsHelper.AddHeaderxNet(rq, $@"sec-ch-ua: ""Not_A Brand"";v=""8"", ""Chromium"";v=""120"", ""Microsoft Edge"";v=""120""
                                            DNT: 1
                                            sec-ch-ua-mobile: ?0
                                            viewport-width: 2510
		...
		public ResultModel EditPost(string link, string content)
		{
			...
			using (var rq = new Leaf.xNet.HttpRequest())
			{
				...
				HttpsHelper.AddHeaderxNet(rq, $@"sec-ch-ua: ""Not_A Brand"";v=""8"", ""Chromium"";v=""120"", ""Google Chrome"";v=""120""
                                            sec-ch-ua-mobile: ?0
                                            viewport-width: 746
